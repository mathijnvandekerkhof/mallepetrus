...
# Quick JIPTV Admin Dashboard Update Script
# Usage: ./quick-admin-update.sh [branch_name_or_number]

clear

echo "╔══════════════════════════════════════════════════════════════╗"
echo "║                ⚡ JIPTV Admin Dashboard Quick Update         ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo
...
echo
echo -e "${YELLOW}⚠${NC} This will update to branch '$BRANCH' and rebuild the admin dashboard Docker image."
...
echo -e "${CYAN}▶${NC} [4/4] Building Docker image: jiptv-admin:latest"
if docker build -t jiptv-admin:latest . --quiet; then
...
echo
echo -e "${GREEN}🎉 Admin Dashboard quick update completed successfully!${NC}"
echo
...
echo
echo -e "${BLUE}💡 Tip:${NC} You can also run: ${CYAN}./quick-admin-update.sh 1${NC} or ${CYAN}./quick-admin-update.sh main${NC}"